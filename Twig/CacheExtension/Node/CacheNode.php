...
namespace Brother\CommonBundle\Twig\CacheExtension\Node;
...
class CacheNode extends \Twig_Node
{
    ...
    {
        parent::__construct(array('key_info' => $keyInfo, 'body' => $body, 'annotation' => $annotation), [], $lineno, $tag);
    }
    ...
    public function compile(\Twig_Compiler $compiler)
    {
        ...
        if (version_compare(\Twig_Environment::VERSION, '1.26.0', '>=')) {
            $extension = 'Brother\CommonBundle\Twig\CacheExtension\Extension';
        } else {
